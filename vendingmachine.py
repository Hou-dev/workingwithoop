...
class HospitalVendingMachine(VendingMachine):
    ...
    def print_days_until_maintenance(days_until_maintenance):
        print(days_until_maintenance)
 
        
class SchoolVendingMachine(VendingMachine):
    # Complete the class

    snack_prices = {"candy": 2.42, "soda": 1.20, "chips": 3.40, "cookies": 3.00}
    student_debt = {"Brian": 200, "Tom": 500, "April": 230}
    def __init__(self, inventory, serial, days_until_maintenance):
        super().__init__(inventory, serial, days_until_maintenance)
    
    def print_student_debt(self,student):
        print(student, SchoolVendingMachine.student_debt[student])
